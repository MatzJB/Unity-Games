...
Disclosure: I use AI (chatGPT) to help me. If I get stuck I would ask if there is a better way and carefully consider all alternatives, but ultimately I am coding everything. 
For code that was solely generated by AI from a simple prompt, I put a comment in the code. All of the art is AI generated (took more time than I anticipated).
