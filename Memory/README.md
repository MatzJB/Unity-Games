...
- [x] Heat haze effect on the desert
- [x] make the cards move and rotate a little, they ate floating after all
- [x] When hovering the cards (with the mouse) they should increase in size and the opposite when not hovering
